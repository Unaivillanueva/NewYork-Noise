...
const displayGraph = (fileName, attributeAccessor, svgGroup, parentDiv, color, colorHover) => {
...
displayGraph('data/noise_types.csv', 'type', g_types, '#v_types_complaints', '#FF3D0D', '#ffa02b');
displayGraph('data/noise_zones.csv', 'zone',  g_zones, '#v_zones_complaints', '#FF3D0D', '#ffa02b');
displayGraph('data/noise_time.csv', 'time', g_time, '#v_time_complaints', '#FF3D0D', '#ffa02b');
displayGraph('data/noise_month.csv', 'month', g_month, '#v_month_complaints', '#FF3D0D', '#ffa02b');